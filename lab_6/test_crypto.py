...
class TestRSASimple:
    """Простые тесты для шифрования RSA"""
...
class TestTDESAdvanced:
    ...
    def test_tdes_encrypt_decrypt_parametrized(self, test_data, key_length):
        ...
        assert len(encrypted) >= 8, "Зашифрованные данные должны содержать как минимум IV"


class TestCryptoSystemAdvanced:
    """Тесты для CryptoSystem с использованием Mock"""
